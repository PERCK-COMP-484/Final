                ...
                <div class="example-block">
                  ...
                  <div class="example-three">
					...
					<div style="text-align: center;">
						...
						<button type='button' class='m-2 mt-3 mx-auto d-block btn btn-info btn-sm'><a href='practiceProblem.php?type=slope'>Click Me for practice Material!</a></button>
					</div>
        </div>
      </div>
    </div>
